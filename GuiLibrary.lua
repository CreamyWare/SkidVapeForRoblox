if shared.VapeExecuted then
	...
	local function vapeGithubRequest(scripturl)
		if not isfile("vape/"..scripturl) then
			local suc, res = pcall(function() return game:HttpGet("https://raw.githubusercontent.com/CreamyWare/SkidVapeForRoblox/"..readfile("vape/commithash.txt").."/"..scripturl, true) end)
			assert(suc, res)
	...
	GuiLibrary["CreateMainWindow"] = function()
		...
		discordbutton.MouseButton1Click:Connect(function()
			...
			task.spawn(function()
				...
				setclipboard("https://discord.gg/DfnNwnMGTY")
				task.wait(1)
				hoverbox3:Remove()
			end)
		end)
